...
export default {
  ...
  actions: {
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    databasePage(context, { vm, basis = 'fullPath', user = false } = {}) {
      return new Promise(resolve => {
        resolve(
          util.db.get(
            pathInit({
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    databasePageClear(context, { vm, basis = 'fullPath', user = false } = {}) {
      return new Promise(resolve => {
        resolve(
          util.db.get(
            pathInit({
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    pageSet(context, { vm, basis = 'fullPath', user = false }) {
      return new Promise(resolve => {
        resolve(
          util.db.get(
            pathInit({
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    pageGet(context, { vm, basis = 'fullPath', user = false }) {
      return new Promise(resolve => {
        resolve(
          cloneDeep(
            util.db
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    pageClear(context, { vm, basis = 'fullPath', user = false }) {
      return new Promise(resolve => {
        resolve(
          util.db.get(
            pathInit({
